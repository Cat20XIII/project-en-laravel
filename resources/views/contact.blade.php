                ...
                <div class="contact-form">
                    ...
                    <form method="POST" action="{{ route('contact') }}">
                        ...
                        <div>
                            ...
                            <span><input name="userName" type="text" class="textbox @if($errors->has('userName'))has-error @endif" value="{{ Request::old('userName') }}"></span>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <span><input name="userPhone" type="text" class="textbox @if($errors->has('userPhone'))has-error @endif" value="{{ Request::old('userPhone') }}"></span>
                        </div>
                        <div>
                            <span><label>Subject</label></span>
                            <span><textarea name="userMsg">{{ Request::old('userMsg') }}</textarea></span>
                        </div>
                        <div>
                            <span><input type="submit" class="" value="Contactez-nous"></span>
                        </div>
                    </form>
                </div>
